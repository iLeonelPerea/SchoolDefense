...
namespace TDA3Game
{
    ...
    public class TDGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //AudioEngine ae = new AudioEngine(Content.RootDirectory + "//Audio//tdgame.xgs");
            //WaveBank wb = new WaveBank(ae, Content.RootDirectory + "//Audio//Wave Bank.xwb");
            //SoundBank sb = new SoundBank(ae, Content.RootDirectory + "//Audio//Sound Bank.xsb");
